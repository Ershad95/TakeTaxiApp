...
public class Messages_HTTP extends AsyncTask<String, Void, Response> {
    final int TIMEOUT=30;
    private final Flag flag;
    private final AlertDialog.Builder builder;
    private final AlertDialog progressDialog;
    public AsyncSendToServer Responce_del = null;
    Context context;
    public Messages_HTTP(Context ctx,Flag flag) {
        context = ctx;
    ...
    protected Response doInBackground(String... params) {
        ...
        try {
            ...
            RequestBody body = new FormBody.Builder().add("json", jsonString).build();
    ...
    protected void onPostExecute(Response response) {
        ...
        progressDialog.hide();
        try {
            Responce_del.Response(response);
        } catch (IOException e) {
            e.printStackTrace();
